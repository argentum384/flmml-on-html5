...
module flmml {
    ...
    export class MOscGbSNoise extends MOscMod {
        ...
        static GB_NOISE_PHASE_DLT: number = 1 << MOscGbSNoise.GB_NOISE_PHASE_SFT
        static GB_NOISE_TABLE_LEN: number = 127;
        static GB_NOISE_TABLE_MOD: number = (MOscGbSNoise.GB_NOISE_TABLE_LEN << MOscGbSNoise.GB_NOISE_PHASE_SFT) - 1;
